    ...
    fields: [
      {
        ...
        type: "password",
        required: true,
        description: "Create API key at cal.com/settings/developer/api-keys",
      },
      {
        name: "event_type_id",
        label: "Event Type ID",
        ...
        description:
          'Find your Event Type ID: Go to cal.com, click on your event type, look at the URL. For "cal.com/username/30min", you need the numeric ID from the API.',
      },
    ],
    documentationUrl: "https://cal.com/docs/api-reference/v2/introduction",
    tools: [
      {
        id: "calcom_get_event_types",
      ...
      },
      {
        ...
        name: "Create Booking",
        description: "Create a booking/appointment directly (no link required)",
        riskLevel: "moderate",
        defaultEnabled: true,
      },
      {
        ...
        name: "List Bookings",
        description: "List bookings/appointments, optionally filtered by date or status",
        riskLevel: "safe",
        defaultEnabled: true,
      },
      {
